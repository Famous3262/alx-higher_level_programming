...
/**
 * print_python_float - Functino that prints data of PyFloatObject
 * @p: the PyObject
 */
...
/**
 * print_python_bytes -Function that prints data of PyBytesObject
 * @p: the PyObject
 */
...
/**
 * print_python_list - Function that prints data of the PyListObject
 *
 * @p: the PyObject
 */
