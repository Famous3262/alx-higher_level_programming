...
In this project, I learned and practice more on object-oriented programming in Python.
For instance, class methods, static methods, class vs instance attributes, and the use of special `__str__` and `__repr__` methods were all put into practice.
