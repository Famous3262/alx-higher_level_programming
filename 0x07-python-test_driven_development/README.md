...
In this project, I practised test-driven development using `docstring`
and `unittest`. I also learned how to write documentation for each module and function
